...
def officer_prompt():
    ...
    while True:
        input_option = raw_input("Select option: ")
...
def agent_prompt(user):
    ...
    while True:
        input_option = raw_input("Selection option: ")
        option = int(input_option)
...
def register_birth(user): #needs nbregplace and new unique id generator
	...
	nbfname = raw_input("Newborn's First Name: ")
	nblname = raw_input("Newborn's Last Name: ")
	...
	nbregplace = str(user)
	nbgender = raw_input("Newborn's Gender (M/F): ") 
	nbf_fname = raw_input("Newborn's Father's First Name: ")
	nbf_lname = raw_input("Newborn's Father's Last Name: ")
	nbm_fname = raw_input("Newborn's Mother's First Name: ")
	nbm_lname = raw_input("Newborn's Mother's Last Name: ")
	...
	while nbmother == []:
		nbm_fname = raw_input("Confirm Mother's first name: ") # Need to make sure this isn't null
		nbm_lname = raw_input("Confirm Mother's last name: ") # Need to make sure this isn't null
		motherbdate = raw_input("What is the Mother's birth date? (YYYY-MM-DD): ")
		motherbplace = raw_input("What is the Mother's birth place? (format): ")
		motheraddress = raw_input("What is the Mother's address? (format): ")
		motherphone = raw_input("What is the Mother's phone number?: (###-###-####)")
	...
	while nbfather == []:
		nbf_fname = raw_input("Confirm Father's first name: ") # Need to make sure this isn't null
		nbf_lname = raw_input("Confirm Father's last name: ") # Need to make sure this isn't null
		fatherbdate = raw_input("What is the Father's birth date? (YYYY-MM-DD): ")
		fatherbplace = raw_input("What is the Father's birth place?: ")
		fatheraddress = raw_input("What is the Father's address?: ")
		fatherphone = raw_input("What is the Father's phone number? (###-###-####): ")
...
def register_marriage(user): #only thing needed is regplace and new uniqueID generator
	...
	#marriageplace = raw_input("Where is the couple getting married?: ") #THIS needs to be the user's city again
	marriageplace = str(user)
	p1fname = raw_input("What is partner 1's first name?: ")
	p1lname = raw_input("What is partner 1's last name?: ")
	p2fname = raw_input("What is partner 2's first name?: ")
	p2lname = raw_input("What is partner 2's last name?: ")
	...
	while partner1 == []:
		p1fname = raw_input("Confirm Partner 1's first name: ") # Need to make sure this isn't null
		p1lname = raw_input("Confirm Partner 1's last name: ") # Need to make sure this isn't null
		partner1bdate = raw_input("What is Partner 1's birth date? (YYYY-MM-DD): ")
		partner1bplace = raw_input("What is the Partner 1's birth place? (format): ")
		partner1address = raw_input("What is the Partner 1's address? (format): ")
		partner1phone = raw_input("What is the Partner 1's phone number?: (###-###-####)")
	...
	while partner2 == []:
		p2fname = raw_input("Confirm Partner 2's first name: ") # Need to make sure this isn't null
		p2lname = raw_input("Confirm Partner 2's last name: ") # Need to make sure this isn't null
		partner2bdate = raw_input("What is the Partner 2's birth date? (YYYY-MM-DD): ")
		partner2bplace = raw_input("What is the Partner 2's birth place?: ")
		partner2address = raw_input("What is the Partner 2's address?: ")
		partner2phone = raw_input("What is the Partner 2's phone number? (###-###-####): ")
...
def renew_vehicle_Reg(): #SWITCH FOR PYTHON 2, FULLY FUNCTIONAL AS OF RIGHT NOW
	...
	vehicleregno = raw_input("Enter the vehicle's registration number: ")
...
def process_bill_of_sale(): #NEED TO CONTROL FOR EXISTING LICENSE PLATE NO. IF HAVE TIME, not explicitly specified. NEED TO SWAP FOR PYTHON 2
	...
	entered_vin = raw_input("What is the VIN of the vehicle that is to be sold?: ")
	current_owner_fname = raw_input("What is the first name of the vehicle's current owner?: ")
	current_owner_lname = raw_input("What is the last name of the vehicle's current owner?: ")
	...
	if (latest_owner_fname == []) or (latest_owner_lname ==[]):
		...
		new_owner_fname = raw_input("What is the first name of the new owner?: ")
		new_owner_lname = raw_input("What is the last name of the new owner?: ")
		entered_plate = raw_input("What is the requested new license plate number?: ")
...
def process_payment(): #FINISHED, MODIFY FOR PYTHON 2
	...
	paymentamount = raw_input("Enter the payment amount: ")
...
def get_driver_abstract(): #NEED TO ADJUST FOR PYTHON 2
	...
	abstract_fname = raw_input("What is the driver's first name?: ")
	abstract_lname = raw_input("What is the driver's last name?: ")
	...
	if len(abstract_regno) > 1:
		...
		optional_order = raw_input("Would you like to see the tickets in order of latest to oldest? (Y/N): ")
		optional_order = optional_order.lower()

		while (optional_order != "y") and (optional_order != "n"):
			optional_order = raw_input("Incorrect response. Would you like to see the tickets in order of latest to oldest? (Y/N): ")
			break
			...
			if optional_order == "y":
				...
				for row in abstract_info:
					...
					if ticket_counter == 5 and number_of_tickets_counter > 5:
						choice_of_five = raw_input("Five tickets have been displayed, would you like to see more? (Y/N): ")
...
def issue_ticket():
    ...
    while True:
        regno = int(raw_input("Enter a registration number: "))
